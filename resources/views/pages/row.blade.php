<div class="setting-row row d-flex " id="setting-row{{$new_row}}">
    <span class='totalrecord-settings'></span>
                                    ...
                                    <div class="col pt-4 mt-2" id="setting-row{{$new_row}}-btn">
                                        <a href="#" class="btn btn-success " id="setting-row{{$new_row}}-href" onclick="addSetting({{$new_row}})"><i class="bi bi-plus-lg"></i> Add</a>
                                    </div>
