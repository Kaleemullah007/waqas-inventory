        ...
        <div class="container">
            ...
            <div class="row my-4">
                ...
                <div class="col-lg-9 col-md-6 col-12 mt-2 text-end">
                    ...
                    <a href="{{ route('create-blog') }}" class="btn btn-sm me-2 btn-primary">
            ...
            <div class="table-responsive">
                <table class="table border table-striped">
                    <thead>
                        <tr>
                            <th>{{__('en.Feature Image')}}</th>
                            <th>{{__('en.Title')}}</th>
                            <th>{{__('en.Tags')}}</th>
                            <th>{{__('en.Status')}}</th>
                            <th>{{__('en.Publish Schedule')}}</th>
                            <th>{{__('en.Action')}}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><img class="img-table" src="/assets/images/img7.png" alt=""></td>
                            <td>This is the title.</td>
                            <td>
                                <span class="badge text-bg-success fw-normal py-2">Mole</span>
                                <span class="badge text-bg-primary fw-normal py-2">Mole Removal</span>
                            </td>
                            <td>
                                <input type="checkbox" checked data-size="sm" data-toggle="toggle" data-on="Published"
                            ...
                            <td>
                                ...
                                <a href="{{route('edit-blog')}}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"
