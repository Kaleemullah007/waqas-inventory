                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 pt-2">
                                ...
                                <input type="text"
                                    ...
                                    value="last name" id="lastName" name="lastName"
                                    value="{{ old('lastName', auth()->user()->name) }}" autocomplete="lastName" required>
                                @error('lastName')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="row d-flex">
                                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                                        ...
                                        <select
                                            ...
                                            <option value="1" @if (old('currency') == 1) 'selected' @endif>US
                                                Dollar
                                            </option>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                                        <label for="date_format"
                                            class="form-label  fs-6">{{ __('en.Date Format') }}</label>
                                        <select
                                            ...
                                            <option value="1" @if (old('date_format') == 1) 'selected' @endif>
                                                dd-mm-yyyy
                                            </option>
                                            <option value="2" @if (old('date_format') == 2) 'selected' @endif>
                                                mm-dd-yyyy
                                            </option>
                                        </select>
                                        @error('date_format')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                                        <label for="current_template"
                                            class="form-label  fs-6">{{ __('en.Current Template') }}</label>
                                        <select
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                                        <label for="business_phone"
                                            class="form-label  fs-6">{{ __('en.Business Phone') }}</label>
                                        <input type="text"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12 mt-2">
                                        <label for="business_email"
                                            class="form-label  fs-6">{{ __('en.Business Email') }}</label>
                                        <input type="email"
