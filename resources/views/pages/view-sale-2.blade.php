    ...
    <div class="container">
        <header>
            ...
            <address >
                ...
                <p>{{ auth()->user()->address }},{{ auth()->user()->country }},{{ auth()->user()->postal_code }}</p>
                <p>{{ auth()->user()->business_email }}</p>
                <p>{{ auth()->user()->business_phone }}</p>
            </address>
            <span><img src="/images/{{auth()->user()->logo}}">
        ...
        <article>
            ...
            <address >
                ...
                <p>{{ $sales->Customer->phone }}</p>
                <p>{{ $sales->Customer->email }}</p>
            ...
            <table class="meta">
                <tr>
                    ...
                    <td><span >{{ $sales->id }}</span></td>
                </tr>
                <tr>
                    <th><span >Date</span></th>
                    <td><span > {{ $sales->created_at->toFormattedDateString() }}</span></td>
                </tr>
                <tr>
                ...
                <tbody>
                    ...
                    @foreach ($sales->Products as $sale)
                        <tr>
                            ...
                            {{-- <td><span >{{ $sale->product_name }}</span></td>
